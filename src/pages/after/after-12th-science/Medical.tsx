...
import { medicalBranches } from "./medicalData";
...
const Medical = () => {
  ...
  const filteredBranches = medicalBranches.filter((branch) => {
    const matchesBranch =
      ...
      <div className="container mx-auto px-4 py-20">
        ...
        <div className="text-center mb-14">
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Explore specializations, salary insights, required skills and job
        ...
        <div className="flex flex-col md:flex-row gap-4 mb-12 justify-center">
          <div className="relative w-full md:w-1/2">
            ...
            <input
              type="text"
              placeholder="Search specialization (Cardiology, Surgery...)"
